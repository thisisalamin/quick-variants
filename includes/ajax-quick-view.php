...
function quick_variants_ajax_quick_view() {
	...
	include QUICK_VARIANTS_PATH . 'templates/quick-view.php';
	$html = ob_get_clean();

	wp_send_json_success( array( 'html' => $html ) );
}
add_action( 'wp_ajax_quick_view_product', 'quick_variants_ajax_quick_view' );
add_action( 'wp_ajax_nopriv_quick_view_product', 'quick_variants_ajax_quick_view' );
