		...
		<form method="post" action="options.php" class="space-y-8" id="qv-settings-form">
			...
			<div class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden">
				<div class="border-b border-gray-200 bg-gray-50/50">
					<nav class="flex px-6">
						<button type="button" class="qv-tab-btn active flex items-center gap-2 px-6 py-4 text-sm font-semibold border-b-2 border-indigo-500 text-indigo-600 bg-white" data-tab="general">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<?php esc_html_e( 'General', 'quick-variants' ); ?>
						</button>
						<button type="button" class="qv-tab-btn flex items-center gap-2 px-6 py-4 text-sm font-semibold border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" data-tab="labels">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
							</svg>
							<?php esc_html_e( 'Labels', 'quick-variants' ); ?>
						</button>
					</nav>
				</div>
